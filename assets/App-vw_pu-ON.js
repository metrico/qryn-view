...
`,ie=()=>{let e=h();return _(`div`,{className:v(re(e)),children:[_(`div`,{className:`logo-section`,children:[m(`img`,{src:te,style:{height:`20px`},alt:`Qryn View`,height:`20px`,className:`logo`}),m(`p`,{className:`version`,children:`3.6.3`}),m(`p`,{className:`path`,children:m(ne,{})})]}),m(`div`,{style:{display:`flex`,alignItems:`center`},children:m(w,{section:`Status Bar`,localProps:e})}),m(Q,{})]})},$=e=>x`
