...
const TimelineColumnResizerStyled = styled.div`
    left: 0;
    position: absolute;
    right: 0;
    top: 0;
...
`;
const draggerDraggingLeft = css`
    border-left: 2px solid #808;
    border-right: 1px solid #999;
`;
const draggerDraggingRight = css`
...
> {
    ...
    render() {
        ...
        return (
            <TimelineColumnResizerStyled
                ref={this._setRootElm}
                data-testid="TimelineColumnResizer"
            >
                <div
                    className={cx(gripIcon, isDragging && gripIconDragging)}
                    style={gripStyle}
                ...
                <div
                    ...
                    className={cx(
                        dragger,
                        isDragging && draggerDragging,
                        isDraggingRight && draggerDraggingRight,
                        isDraggingLeft && draggerDraggingLeft
                    )}
