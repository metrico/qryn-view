...
module.exports = function(app:any) {
    app.use('/api/traces/d6e9329d67b6146e0000000000000000/json', function (req:any, res:any, next:any) {
        res.json({
            "resourceSpans":[
                {
                    "resource":{
    ...
    app.use('/api/traces/d6e9329d67b6146e0000000000000001/json', function (req:any, res:any, next:any) {
        res.json({
            "resourceSpans":[
                {
                    "resource":{
