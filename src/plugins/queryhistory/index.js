      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Click ‘Clear History’ to delete your {dialogType} history
            permanently
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          ...
          <HistoryRow key={index}>
            ...
            <div style={{ display: "flex" }}>
              <Tooltip title={"Copy Query to Clipboard"}>
                <HistoryButton onClick={(e) => copyQuery(item.data)}>
              ...
              <Tooltip title={"Star / Unstar Query"}>
                <HistoryButton onClick={(e) => handleStarItem(item)}>
                  {item.starred ? (
          ...
          <HistoryRow key={index}>
            ...
            >
              <Tooltip title={"API URL"}>
                ...
                >
                  <LinkIcon fontSize="14px" style={{ marginRight: "3px" }} />{" "}
                  {item?.params?.apiUrl}
                </span>
              </Tooltip>
  ...
  return (
    <TabHeaderContainer>
      ...
      >
        ...
        />{" "}
        <span style={{ margin: "0px 4px" }}>Total: {queryHistory.length}</span>
      </div>
    </TabHeaderContainer>
  );
}
    ...
    <QueryHistoryContainer>
      <div style={{ display: "flex" }}>
        <SettingItemContainer>
          ...
          <small>Delete all of your query history, permanently.</small>
          <AlertDialog dialogType={"Query"} clearHistory={clearHistory} />
        </SettingItemContainer>
        <SettingItemContainer>
          <div>Clear Links History</div>
          <small>Delete all of your links history, permanently.</small>
          <AlertDialog dialogType={"Links"} clearHistory={clearLinksHistory} />
        </SettingItemContainer>
      </div>
    </QueryHistoryContainer>
  );
