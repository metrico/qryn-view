...
export const getTableStyles = (theme) => {
    ...
    const rowHoverBg = theme.colors.emphasize(
    ...
    const buildCellContainerStyle = (
        ...
        return css`
            label: ${overflowOnHover
                ? "cellContainerOverflow"
                : "cellContainerNoOverflow"};
    ...
    return {
        ...
        cellContainerNoOverflow: buildCellContainerStyle(
            undefined,
            undefined,
            false
        ),
