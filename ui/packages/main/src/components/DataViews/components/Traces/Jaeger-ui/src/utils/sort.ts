...
export function localeStringComparator(itemA:any, itemB:any) {
  return itemA.localeCompare(itemB);
}

export function numberSortComparator(itemA:any, itemB:any) {
  return itemA - itemB;
}

export function classNameForSortDir(dir:any) {
...
export function createSortClickHandler(column:any, currentSortKey:any, currentSortDir:any, updateSort:any) {
