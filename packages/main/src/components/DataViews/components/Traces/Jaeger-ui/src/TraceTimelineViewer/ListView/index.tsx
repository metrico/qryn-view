...
export default class ListView extends React.Component<TListViewProps> {
    ...
    scrollToIndex = (index: number) => {
        ...
        const listViewTop =
            ...
            (this._itemHolderElm?.getBoundingClientRect().top || 0);
    ...
    _isViewChanged() {
        ...
        return (
            clientHeight !== this._viewHeight || scrollTop !== this._scrollTop
        );
    }
    ...
    _calcViewIndexes() {
        ...
        this._startIndex = this._yPositions.findFloorIndex(
            yStart,
            this._getHeight
        );
    ...
    render() {
        ...
        if (!this._wrapperElm) {
            ...
            const maxStart =
                viewBufferMin > this._startIndex
                    ? 0
                    : this._startIndex - viewBufferMin;
            const minEnd =
                viewBufferMin < dataLength - this._endIndex
                    ? this._endIndex + viewBufferMin
                    : dataLength - 1;
            if (
                maxStart < this._startIndexDrawn ||
                minEnd > this._endIndexDrawn
            ) {
                start =
                    viewBuffer > this._startIndex
                        ? 0
                        : this._startIndex - viewBuffer;
