...
export function selectTheme(theme: any, mainTheme: any) {
    return {
        ...
        colors: {
            ...theme.colors,
            primary: mainTheme.contrast,
            neutral90: mainTheme.accentNeutral,
            neutral80: mainTheme.contrast,
            neutral0: mainTheme.deep,
            primary25: mainTheme.shadow,
            neutral5: mainTheme.shadow,
            neutral10: mainTheme.shadow,
        },
    };
}
